                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Edit a Edit category</h5>
                                <div class="card-body">
                                    <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                                        <div class="form-group">
                                            <label for="inputCategory">Category Name</label>
                                            <input id="inputCategory" type="text" name="category" d
                                            ata-parsley-trigger="change" required=""
                                             placeholder="Enter a Category" autocomplete="off" class="form-control">
                                        </div>
                                         <div class="form-group">
                                            <label for="inputCategoryImage">Category Image URL</label>
                                            <input id="inputCategoryImage" type="text" name="image_url" d
                                            ata-parsley-trigger="change" required=""
